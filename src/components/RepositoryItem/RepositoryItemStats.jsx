  ...
  return (
    <View style={[styles.listItem.row, styles.listItem.stats, styles.evenPadding]}>
      <View style={styles.listItem.column}>
        <Text style={styles.titleText} >{numberCompactor(item.stargazersCount)}</Text>
        <Text style={styles.descriptionText}  >Stars</Text>
      </View>
      <View style={styles.listItem.column}>
        <Text style={styles.titleText} >{numberCompactor(item.forksCount)}</Text>
        <Text style={styles.descriptionText} >Forks</Text>
      </View>
      <View style={styles.listItem.column}>
        <Text style={styles.titleText} >{numberCompactor(item.reviewCount)}</Text>
        <Text style={styles.descriptionText} >Reviews</Text>
      </View>
      <View style={styles.listItem.column}>
        <Text style={styles.titleText} >{numberCompactor(item.ratingAverage)}</Text>
